...
function TimelineItem({ item }: TimelineItemProps) {
  return (
    <div className="relative mb-[50px] last:mb-0">
      ...
      <div className="bg-white text-[#1c1b29] p-[25px] md:p-[40px] rounded-[25px] relative shadow-[0_10px_30px_rgba(0,0,0,0.2)] ml-0 md:ml-0">
...
export default function Experience({
  ...
  return (
    <>
      <section
        id="experience"
        className="py-[60px] md:py-[100px] px-[20px] md:px-[60px] bg-[#15141f] text-white overflow-hidden"
      >
